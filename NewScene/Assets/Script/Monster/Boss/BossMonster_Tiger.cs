...
public class BossMonster_Tiger : MonoBehaviour
{
    ...
    [SerializeField] private int CurrentTigerHP;
    [SerializeField] private int MaxTigerHP;
    ...
    {
        if (other.tag == "Main_gangrim" && isDash)
        {
            isDash = false;
        ...
        {
            CurrentTigerHP -= 1;
            StartCoroutine(HitCheckColor());
        }
    }
    IEnumerator HitCheckColor()
    {
        mat.color = Color.red;
